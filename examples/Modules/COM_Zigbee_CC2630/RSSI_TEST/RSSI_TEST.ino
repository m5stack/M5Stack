 ...
 */
/*
 * @Hardwares: M5Core + Module COMX Zigbee
...
// Description: By enabling or deleting the macro definition `COORDINNATOR`, burn the program to the two devices
// respectively After booting, `Coordinator` will continuously broadcast data, `End Device` will display the current
// signal strength and data packet loss Note: 16 and 17 of the DIP switch are set to ON.
...
uint16_t posbuff[10][2] = {
    {180, 60}, {200, 60}, {220, 60}, {240, 60}, {260, 60},
