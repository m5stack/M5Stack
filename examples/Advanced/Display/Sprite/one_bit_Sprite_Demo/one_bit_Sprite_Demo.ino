...
void drawStar(int x, int y, int star_color) {
    ...
    // Create an 1 bit (2 colour) sprite 70x80 pixels (uses 70*80/8 = 700 bytes
    // of RAM) Colour depths of 8 bits per pixel and 16 bits are also supported.
    ...
    // Specify what colour is to be treated as transparent (black in this
    // example)
    img.pushSprite(x, y, transparent);

    // Delete Sprite to free memory, creating and deleting takes very little
    // time.
    img.deleteSprite();
}
// =========================================================================
