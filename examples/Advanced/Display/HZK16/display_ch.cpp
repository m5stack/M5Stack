...
void DisplayCh::loadHzk16(Hzk16Types hzkTypes, const char *HZK16Path,
...
void DisplayCh::writeHzkAsc(const char c) {
    if (c == '\n') {
        ...
        if (highlighted) {
            M5.Lcd.fillRect(cursor_x, cursor_y, ascCharWidth, ascCharHeigth,
                            highlightcolor);
            ...
            for (uint8_t col = 0; col < 8; col++) {
                if ((*pCharMatrix & mask) != 0) {
                    if (textsize == 1) {
                        ...
                        M5.Lcd.fillRect(posX, posY, textsize, textsize,
                                        textcolor);
                    }
                }
...
void DisplayCh::writeHzkGbk(const char *c) {
    ...
    if (highlighted) {
        M5.Lcd.fillRect(cursor_x, cursor_y, gbkCharWidth, gbkCharHeight,
                        highlightcolor);
        ...
        for (uint8_t col = 0; col < 8; col++) {
            ...
            if ((*(pCharMatrix + 1) & mask) != 0) {
                if (textsize == 1) {
                    ...
                    M5.Lcd.fillRect(posX + ascCharWidth, posY, textsize,
                                    textsize, textcolor);
                }
            }
