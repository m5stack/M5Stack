...
The M5Stack has three internal I2C devices at address 0x68, 0x75 and 0x10.
该程序连续扫描地址 1-127 并显示在 TFT 上发现的设备。
M5Stack 在地址0x10, 0x68, 0x75 处有三个内部 I2C 设备。
*/
#include <M5Stack.h>
...
void setup()
{
  ...
  M5.Lcd.println("M5StackFire I2C Tester"); //Print a string on the screen.  在屏幕上打印字符串
  delay(3000);
